export default {
    ...
    "entry.year.label": "Für welches Jahr werden die Mittel beantragt?",
    "entry.year.placeholder": "Bitte auswählen",
    "entry.grades.label": "Für welche Jahrgangsstufen wird die Maßnahme beantragt?",
    "entry.grades.description": "Mehrfachnennung möglich. Zum Entfernen einer Auswahl bitte auf die unten erscheinende Jahrgangsstufe klicken.",
    "entry.grades.placeholder": "Bitte auswählen",
    "entry.subjects.label": "Welche Fächer können der Maßnahme {{index}} zugeordnet werden?",
    "entry.subjects.description": "Mehrfachnennung möglich. Zum Entfernen einer Auswahl bitte auf das unten erscheinende Fach klicken.",
